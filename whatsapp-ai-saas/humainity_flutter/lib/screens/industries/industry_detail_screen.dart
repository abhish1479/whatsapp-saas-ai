...
class IndustryDetailScreen extends StatelessWidget {
  ...
  factory IndustryDetailScreen.fromRoute(
      BuildContext context, GoRouterState s) {
    final extra = s.extra;
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child:
                        Icon(industry.icon, color: AppColors.primary, size: 20),
                  ),
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Text(
          text,
          style: TextStyle(
              color: isUser ? Colors.black87 : AppColors.primary.shade700),
        ),
      ),
    );
  }
    ...
    return Container(
      ...
      child: Center(
        child: Wrap(
          ...
          runSpacing: 12,
          alignment: WrapAlignment.center,
          children: industry.integrations
              .map((i) => Chip(
                    label: Text(i),
